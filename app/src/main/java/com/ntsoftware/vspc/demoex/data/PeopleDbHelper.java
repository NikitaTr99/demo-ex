...
public class PeopleDbHelper extends SQLiteOpenHelper {
    ...
    String insert_q = "INSERT INTO " + PeopleContract.PeopleEntry.TABLE_NAME
            ...
            + "('Человек 2','Человек 2','10.04.1989','test@email.com', 'Какой то чел.'),"
            + "('Человек 3','Человек 3','10.04.1989','test@email.com', 'Какой то чел.'),"
            + "('Человек 4','Человек 4','10.04.1989','test@email.com', 'Какой то чел.'),"
            + "('Человек 5','Человек 5','10.04.1989','test@email.com', 'Какой то чел.'),"
            + "('Человек 6','Человек 6','10.04.1989','test@email.com', 'Какой то чел.'),"
            + "('Человек 7','Человек 7','10.04.1989','test@email.com', 'Какой то чел.'),"
            + "('Человек 8','Человек 8','10.04.1989','test@email.com', 'Какой то чел.')";
